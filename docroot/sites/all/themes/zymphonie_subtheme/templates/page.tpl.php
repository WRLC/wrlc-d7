...
<div id="header_wrapper">
  <header id="header" class="clearfix">
    <div class="top_left">
      ...
      <?php endif; ?>
      <h1 id="site-title"> <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a>
        <div id="site-description"><?php print $site_slogan; ?></div>
      </h1>
    </div>
    <?php if ($main_menu): ?>
    <div class="top_right">
      <nav id="main-menu"  role="navigation"> <a class="nav-toggle" href="#">Menu</a>
...
<?php if ($is_front): ?>
<div class="slideshow-wrap"> <?php print render($page['slideshow']); ?> <?php print render($page['front_welcome']); ?> </div>
<?php endif; ?>
<div id="page-wrap">
  ...
  <?php endif; ?>
  <div class="wrap two-col-img"> <?php print render($page['two_col1_block1']); ?> <?php print render($page['two_col1_block2']); ?> </div>
  <div class="wrap two-col-img"> <?php print render($page['two_col2_block1']); ?> <?php print render($page['two_col2_block2']); ?> </div>
  <div id="container">
    <div class="container-wrap">
      <div class="content-sidebar-wrap">
        <div id="content">
          ...
          <?php endif; ?>
          <section id="post-content" role="main"> <?php print $messages; ?> <?php print render($title_prefix); ?>
            <?php if ($title): ?>
...
<div id="footer">
  ...
  <div class="footer_credit">
    <div id="copyright" class="full-wrap clearfix">
      ...
      <p class="credits"> <?php print t('A Service of '); ?><a href="https://www.wrlc.org">WRLC</a></p>
    </div>
  </div>
</div>
