...
<div id="wrap" class="clr container">
  ...
  <footer id="copyright-wrap" class="clear">
    <div id="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a> WRLC | 901 Commerce Drive, Upper Marlboro, MD 20774 | <a href="https://docs.google.com/a/wrlc.org/forms/d/1ZwUxPEeGGLB2xcuOfmR_TtXf8cF_MaAq0IcuUhTDARg/viewform" target="_blank">Feedback</a></div>
  </footer>
</div>