...
<div id="header_wrapper">
    ...
    <header id="header" role="banner">
      ...
      <div class="top_right">
        ...
        <div class="search_block">
          ...
          <?php if (theme_get_setting('social_links', 'office_responsive_theme')): ?>
            <div class="social-icons">
             <ul>
              <li><a class="rss" href="<?php print $front_page; ?>rss.xml">RSS</a></li>
              <li><a class="fb" href="<?php echo theme_get_setting('facebook_profile_url', 'office_responsive_theme'); ?>" target="_blank" rel="me">Facebook</a></li>
              <li><a class="twitter" href="<?php echo theme_get_setting('twitter_profile_url', 'office_responsive_theme'); ?>" target="_blank" rel="me">Twitter</a></li>

              <li><a class="gplus" href="<?php echo theme_get_setting('gplus_profile_url', 'office_responsive_theme'); ?>" target="_blank" rel="me">Gplus</a></li>
              <li><a class="linkedin" href="<?php echo theme_get_setting('linkedin_profile_url', 'office_responsive_theme'); ?>" target="_blank" rel="me">linkedin</a></li>
              <li><a class="pinterest" href="<?php echo theme_get_setting('pinterest_profile_url', 'office_responsive_theme'); ?>" target="_blank" rel="me">pinterest</a></li>
              <li><a class="vimeo" href="<?php echo theme_get_setting('vimeo_profile_url', 'office_responsive_theme'); ?>" target="_blank" rel="me">vimeo</a></li>
             </ul>
            </div>
          <?php endif; ?>
        </div>
  ...
  <div id="container">
    ...
    <div id="content">
      <?php if (theme_get_setting('breadcrumbs', 'office_responsive_theme')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
      <?php print $messages; ?>
      <?php if ($is_front): ?>
...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> 901 Commerce Drive, Upper Marlboro, MD 20774 | (301) 390-2000</p> 
    <div class="clear"></div>
    </div>
  </div>
  </div>
